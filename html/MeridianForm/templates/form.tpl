...
<label class="choice" for="OVER_18">I Certify that I am at least 18 years of Age and am legally able to sign this medical form.</label>
		...
		<span>
			<input id="FEET" name= "FEET" class="element text" maxlength="255" size="8" value="{$user_data.FEET}"/>
			<label>Feet</label>
		</span>
		<span>
			<input id="INCHES" name= "INCHES" class="element text" maxlength="255" size="14" value="{$user_data.INCHES}"/>
			<label>Inches</label>
		</span> 
		</li>		<li id="li_51" >
		...
		<span>
			<input id="ALL" name="SOURCE" class="element checkbox" type="checkbox" value="Doc" {if $user_data.SOURCE eq 'Doc'}checked{/if}/>
<label class="choice" for="ALL">Dr. Referral</label>
			<input id="APPOINTMENT" name="SOURCE" class="element checkbox" type="checkbox" value="Friend" {if $user_data.SOURCE eq 'Friend'}checked{/if}/>
<label class="choice" for="APPOINTMENT">Friend/Colleague</label>
			<input id="ALL" name="SOURCE" class="element checkbox" type="checkbox" value="Previous" {if $user_data.SOURCE eq 'Previous'}checked{/if}/>
<label class="choice" for="ALL">Previous Patient</label>
			<input id="APPOINTMENT" name="SOURCE" class="element checkbox" type="checkbox" value="Other" {if $user_data.SOURCE eq 'Other'}checked{/if}/>
