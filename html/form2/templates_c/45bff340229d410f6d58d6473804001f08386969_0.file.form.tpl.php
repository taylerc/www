<?php /* Smarty version 3.1.27, created on 2015-12-04 00:56:54
         compiled from "/Library/WebServer/Documents/www/html/form2/templates/form.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:14339200305660e4d6cd9a26_87914290%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45bff340229d410f6d58d6473804001f08386969' => 
    array (
      0 => '/Library/WebServer/Documents/www/html/form2/templates/form.tpl',
      1 => 1441134748,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14339200305660e4d6cd9a26_87914290',
  'variables' => 
  array (
    'user_data' => 0,
  ),
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5660e4d6db75a4_19730511',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5660e4d6db75a4_19730511')) {
function content_5660e4d6db75a4_19730511 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '14339200305660e4d6cd9a26_87914290';
?>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_1008734" class="appnitro"  method="post" action="../htdocs/action1.php">
...
"/>
		...
		<span>
			<input id="PHONE_1" name="PHONE_1" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PHONE_1'];?>
" type="text"> -
			<label for="PHONE_1">(###)</label>
		</span>
		<span>
			<input id="PHONE_2" name="PHONE_2" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PHONE_2'];?>
" type="text"> -
			<label for="PHONE_2">###</label>
		</span>
		<span>
	 		<input id="PHONE_3" name="PHONE_3" class="element text" size="4" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PHONE_3'];?>
" type="text">
...
"/> 
		...
		<label class="description" for="SOURCE">Where did you hear about us? </label>
		<div>
			<input id="SOURCE" name="SOURCE" class="element text large" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SOURCE'];?>
"/> 
		</div> 
		</li>		
...
" type="text">
 ...
 type="text">
		...
		<div>
			<input id="REFERRING_PHYSICIAN" name="REFERRING_PHYSICIAN" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['REFERRING_PHYSICIAN'];?>
"/> 
		</div> 
		</li>		<li id="li_11" >
...
"/> 
		...
		<span>
			<input id="SPOUSE_HOME_PHONE_1" name="SPOUSE_HOME_PHONE_1" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SPOUSE_HOME_PHONE_1'];?>
" type="text"> -
			<label for="SPOUSE_HOME_PHONE_1">(###)</label>
		</span>
		<span>
			<input id="SPOUSE_HOME_PHONE_2" name="SPOUSE_HOME_PHONE_2" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SPOUSE_HOME_PHONE_2'];?>
" type="text"> -
			<label for="SPOUSE_HOME_PHONE_2">###</label>
		</span>
		<span>
	 		<input id="SPOUSE_HOME_PHONE_3" name="SPOUSE_HOME_PHONE_3" class="element text" size="4" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SPOUSE_HOME_PHONE_3'];?>
" type="text">
...
" type="text">
		...
		<label class="description" for="SPOUSE_SSN">S.S. Number </label>
		<div>
...
" type="text">
		...
		<span>
			<input id="MOTHER_EMPLOYER_PHONE_1" name="MOTHER_EMPLOYER_PHONE_1" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['MOTHER_EMPLOYER_PHONE_1'];?>
" type="text"> -
			<label for="MOTHER_EMPLOYER_PHONE_1">(###)</label>
		</span>
		<span>
			<input id="MOTHER_EMPLOYER_PHONE_2" name="MOTHER_EMPLOYER_PHONE_2" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['MOTHER_EMPLOYER_PHONE_2'];?>
" type="text"> -
			<label for="MOTHER_EMPLOYER_PHONE_2">###</label>
		</span>
		<span>
	 		<input id="MOTHER_EMPLOYER_PHONE_3" name="MOTHER_EMPLOYER_PHONE_3" class="element text" size="4" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['MOTHER_EMPLOYER_PHONE_3'];?>
" type="text">
		...
		<span>
			<input id="element_26_1" name= "FATHER_FIRST" class="FATHER_FIRST" maxlength="255" size="8" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['FATHER_FIRST'];?>
"/>
			<label>First</label>
		</span>
		<span>
...
" type="text">
		...
		<div>
			<input id="FATHER_SSN" name="FATHER_SSN" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['FATHER_SSN'];?>
"/> 
		</div> 
		</li>		<li id="li_29" >
...
" type="text">
		...
		<span>
			<input id="FATHER_EMPLOYER_PHONE_1" name="FATHER_EMPLOYER_PHONE_1" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['FATHER_EMPLOYER_PHONE_1'];?>
" type="text"> -
			<label for="FATHER_EMPLOYER_PHONE_1">(###)</label>
		</span>
		<span>
			<input id="FATHER_EMPLOYER_PHONE_2" name="FATHER_EMPLOYER_PHONE_2" class="element text" size="3" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['FATHER_EMPLOYER_PHONE_2'];?>
" type="text"> -
			<label for="FATHER_EMPLOYER_PHONE_2">###</label>
		</span>
		<span>
	 		<input id="FATHER_EMPLOYER_PHONE_3" name="FATHER_EMPLOYER_PHONE_3" class="element text" size="4" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['FATHER_EMPLOYER_PHONE_3'];?>
" type="text">
		...
		<div>
			<input id="PRIMARY_INSURANCE_NAME" name="PRIMARY_INSURANCE_NAME" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PRIMARY_INSURANCE_NAME'];?>
"/> 
		</div> 
		</li>		<li id="li_34" >
		...
		<div>
			<input id="PRIMARY_INSURANCE_ADDRESS_1" name="PRIMARY_INSURANCE_ADDRESS_1" class="element text large" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PRIMARY_INSURANCE_ADDRESS_1'];?>
" type="text">
			<label for="PRIMARY_INSURANCE_ADDRESS_1">Street Address</label>
		</div>
	
		<div>
			<input id="PRIMARY_INSURANCE_ADDRESS_2" name="PRIMARY_INSURANCE_ADDRESS_2" class="element text large" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PRIMARY_INSURANCE_ADDRESS_2'];?>
" type="text">
			<label for="PRIMARY_INSURANCE_ADDRESS_2">Address Line 2</label>
		</div>
	
		<div class="left">
			<input id="PRIMARY_INSURANCE_CITY" name="PRIMARY_INSURANCE_CITY" class="element text medium" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PRIMARY_INSURANCE_CITY'];?>
" type="text">
			<label for="PRIMARY_INSURANCE_CITY">City</label>
		</div>
	
		<div class="right">
			<input id="PRIMARY_INSURANCE_STATE" name="PRIMARY_INSURANCE_STATE" class="element text medium" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PRIMARY_INSURANCE_STATE'];?>
" type="text">
			<label for="PRIMARY_INSURANCE_STATE">State / Province / Region</label>
		</div>
	
		<div class="left">
			<input id="PRIMARY_INSURANCE_ZIP" name="PRIMARY_INSURANCE_ZIP" class="element text medium" maxlength="15" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PRIMARY_INSURANCE_ZIP'];?>
" type="text">
		...
		<span>
			<input id="PI_SUBSCRIBER_FIRST" name= "PI_SUBSCRIBER_FIRST" class="element text" maxlength="255" size="8" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_FIRST'];?>
"/>
			<label>First</label>
		</span>
		<span>
			<input id="PI_SUBSCRIBER_LAST" name= "PI_SUBSCRIBER_LAST" class="element text" maxlength="255" size="14" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_LAST'];?>
"/>
			<label>Last</label>
		</span> 
		</li>		<li id="li_36" >
		...
		<div>
			<input id="PI_SUBSCRIBER_EMPLOYER" name="PI_SUBSCRIBER_EMPLOYER" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_EMPLOYER'];?>
"/> 
		</div> 
		</li>		<li id="li_37" >
		<label class="description" for="PI_SUBSCRIBER_ID">Subscriber's ID Number </label>
		<div>
			<input id="PI_SUBSCRIBER_ID" name="PI_SUBSCRIBER_ID" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_ID'];?>
"/> 
		</div> 
		</li>		<li id="li_38" >
		<label class="description" for="PI_SUBSCRIBER_GROUP_NUMBER">Group Number </label>
		<div>
			<input id="PI_SUBSCRIBER_GROUP_NUMBER" name="PI_SUBSCRIBER_GROUP_NUMBER" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_GROUP_NUMBER'];?>
"/> 
		</div>                                                
		</li>		<li id="li_39" >
		<label class="description" for="PI_SUBSCRIBER_DOB">Date of Birth </label>
		<span>
			<input id="PI_SUBSCRIBER_DOB_1" name="PI_SUBSCRIBER_DOB_1" class="element text" size="2" maxlength="2" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_DOB_1'];?>
" type="text"> /
			<label for="PI_SUBSCRIBER_DOB_1">MM</label>
		</span>
		<span>
			<input id="PI_SUBSCRIBER_DOB_2" name="PI_SUBSCRIBER_DOB_2" class="element text" size="2" maxlength="2" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_DOB_2'];?>
" type="text"> /
			<label for="PI_SUBSCRIBER_DOB_2">DD</label>
		</span>
		<span>
	 		<input id="PI_SUBSCRIBER_DOB_3" name="PI_SUBSCRIBER_DOB_3" class="element text" size="4" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['PI_SUBSCRIBER_DOB_3'];?>
" type="text">
...
>
		...
		<div>
			<input id="SECONDARY_INSURANCE_NAME" name="SECONDARY_INSURANCE_NAME" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SECONDARY_INSURANCE_NAME'];?>
"/> 
		</div> 
		</li>		<li id="li_41" >
		...
		<div>
			<input id="SECONDARY_INSURANCE_ADDRESS_1" name="SECONDARY_INSURANCE_ADDRESS_1" class="element text large" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SECONDARY_INSURANCE_ADDRESS_1'];?>
" type="text">
			<label for="SECONDARY_INSURANCE_ADDRESS_1">Street Address</label>
		</div>
	
		<div>
			<input id="SECONDARY_INSURANCE_ADDRESS_2" name="SECONDARY_INSURANCE_ADDRESS_2" class="element text large" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SECONDARY_INSURANCE_ADDRESS_2'];?>
" type="text">
			<label for="SECONDARY_INSURANCE_ADDRESS_2">Address Line 2</label>
		</div>
	
		<div class="left">
			<input id="SECONDARY_INSURANCE_CITY" name="SECONDARY_INSURANCE_CITY" class="element text medium" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SECONDARY_INSURANCE_CITY'];?>
" type="text">
			<label for="SECONDARY_INSURANCE_CITY">City</label>
		</div>
	
		<div class="right">
			<input id="SECONDARY_INSURANCE_STATE" name="SECONDARY_INSURANCE_STATE" class="element text medium" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SECONDARY_INSURANCE_STATE'];?>
" type="text">
			<label for="SECONDARY_INSURANCE_STATE">State / Province / Region</label>
		</div>
	
		<div class="left">
			<input id="SECONDARY_INSURANCE_ZIP" name="SECONDARY_INSURANCE_ZIP" class="element text medium" maxlength="15" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SECONDARY_INSURANCE_ZIP'];?>
" type="text">
		...
		<span>
			<input id="SI_SUBSCRIBER_FIRST" name= "SI_SUBSCRIBER_FIRST" class="element text" maxlength="255" size="8" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_FIRST'];?>
"/>
			<label>First</label>
		</span>
		<span>
			<input id="SI_SUBSCRIBER_LAST" name= "SI_SUBSCRIBER_LAST" class="element text" maxlength="255" size="14" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_LAST'];?>
"/>
			<label>Last</label>
		</span> 
		</li>		<li id="li_43" >
		...
		<div>
			<input id="SI_SUBSCRIBER_EMPLOYER" name="SI_SUBSCRIBER_EMPLOYER" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_EMPLOYER'];?>
"/> 
		</div> 
		</li>		<li id="li_44" >
		<label class="description" for="SI_SUBSCRIBER_ID">Subscriber's ID Number </label>
		<div>
			<input id="SI_SUBSCRIBER_ID" name="SI_SUBSCRIBER_ID" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_ID'];?>
"/> 
		</div> 
		</li>		<li id="li_45" >
		<label class="description" for="SI_SUBSCRIBER_GROUP_NUMBER">Group Number </label>
		<div>
			<input id="SI_SUBSCRIBER_GROUP_NUMBER" name="SI_SUBSCRIBER_GROUP_NUMBER" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_GROUP_NUMBER'];?>
"/> 
		</div> 
		</li>		<li id="li_46" >
		<label class="description" for="SI_SUBSCRIBER_DOB">Date of Birth </label>
		<span>
			<input id="SI_SUBSCRIBER_DOB_1" name="SI_SUBSCRIBER_DOB_1" class="element text" size="2" maxlength="2" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_DOB_1'];?>
" type="text"> /
			<label for="SI_SUBSCRIBER_DOB_1">MM</label>
		</span>
		<span>
			<input id="SI_SUBSCRIBER_DOB_2" name="SI_SUBSCRIBER_DOB_2" class="element text" size="2" maxlength="2" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_DOB_2'];?>
" type="text"> /
			<label for="SI_SUBSCRIBER_DOB_2">DD</label>
		</span>
		<span>
	 		<input id="SI_SUBSCRIBER_DOB_3" name="SI_SUBSCRIBER_DOB_3" class="element text" size="4" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SI_SUBSCRIBER_DOB_3'];?>
" type="text">
...
>
		...
		<span>
			<input id="NEED_TREATMENT_FOR_1" name="NEED_TREATMENT_FOR" class="element radio" type="radio" value="OTI" <?php if ($_smarty_tpl->tpl_vars['user_data']->value['NEED_TREATMENT_FOR'] == 'OTI') {?>checked<?php }?> />
<label class="choice" for="NEED_TREATMENT_FOR_1">On the Job Injury</label>
<input id="NEED_TREATMENT_FOR_2" name="NEED_TREATMENT_FOR" class="element radio" type="radio" value="Auto" <?php if ($_smarty_tpl->tpl_vars['user_data']->value['NEED_TREATMENT_FOR'] == 'Auto') {?>checked<?php }?>/>
<label class="choice" for="NEED_TREATMENT_FOR_2">Auto</label>
<input id="NEED_TREATMENT_FOR_3" name="NEED_TREATMENT_FOR" class="element radio" type="radio" value="Accident" <?php if ($_smarty_tpl->tpl_vars['user_data']->value['NEED_TREATMENT_FOR'] == 'Accident') {?>checked<?php }?>/>
<label class="choice" for="NEED_TREATMENT_FOR_3">Accident</label>
		...
		<span>
			<input id="DATE_OF_INJURY_1" name="DATE_OF_INJURY_1" class="element text" size="2" maxlength="2" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['DATE_OF_INJURY_1'];?>
" type="text"> /
			<label for="DATE_OF_INJURY_1">MM</label>
		</span>
		<span>
			<input id="DATE_OF_INJURY_2" name="DATE_OF_INJURY_2" class="element text" size="2" maxlength="2" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['DATE_OF_INJURY_2'];?>
" type="text"> /
			<label for="DATE_OF_INJURY_2">DD</label>
		</span>
		<span>
	 		<input id="DATE_OF_INJURY_3" name="DATE_OF_INJURY_3" class="element text" size="4" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['DATE_OF_INJURY_3'];?>
" type="text">
...
>
		...
		<div>
			<input id="CLAIM_NUMBER" name="CLAIM_NUMBER" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['CLAIM_NUMBER'];?>
"/> 
		</div> 
		</li>		<li class="section_break">
...
services rendered. I have received this practice’s <a href="http://www.columbiaphysicaltherapypasco.com/hippa-privacy-policy/" target="_blank">Notice of Privacy Practices</a> written in plain language. </h3>
		...
		<div>
			<input id="SIGNATURE" name="SIGNATURE" class="element text medium" type="text" maxlength="255" value="<?php echo $_smarty_tpl->tpl_vars['user_data']->value['SIGNATURE'];?>
" required/> 
