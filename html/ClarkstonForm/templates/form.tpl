...
<body id="main_body" >
	...
	<div id="form_container">
		...
		</li>		<li id="EMERGENCY_PHONE" >
		<label class="description" for="EMERGENCY_PHONE">Emergency Phone </label>
		<span>
			<input id="EMERGENCY_PHONE_1" name="EMERGENCY_PHONE_1" class="element text" size="3" maxlength="3" value="{$user_data.EMERGENCY_PHONE_1}" type="text"> -
			<label for="EMERGENCY_PHONE_1">(###)</label>
		</span>
		<span>
			<input id="EMERGENCY_PHONE_2" name="EMERGENCY_PHONE_2" class="element text" size="3" maxlength="3" value="{$user_data.EMERGENCY_PHONE_2}" type="text"> -
			<label for="EMERGENCY_PHONE_2">###</label>
		</span>
		<span>
	 		<input id="EMERGENCY_PHONE_3" name="EMERGENCY_PHONE_3" class="element text" size="4" maxlength="4" value="{$user_data.EMERGENCY_PHONE_3}" type="text">
			<label for="EMERGENCY_PHONE_3">####</label>
		</span>
		</li>		<li id="li_4" >
...
<label class="choice" for="GENDER_F">Female</label>
		...
		</li>		<li id="DIAGNOSIS_CODE" >
		<label class="description" for="DIAGNOSIS_CODE">Diagnosis Code </label>
		<div>
			<input id="DIAGNOSIS_CODE" name="DIAGNOSIS_CODE" class="element text medium" type="text" maxlength="255" value="{$user_data.DIAGNOSIS_CODE}"/> 
		</div> 
		</li>		<li class="section_break">
...
<label class="choice" for="NEED_TREATMENT_FOR_3">Accident</label>
		...
		</li>		<li id="EMERGENCY_CONTACT" >
		<label class="description" for="EMERGENCY_CONTACT_ADDRESS">Address </label>
		
		<div>
			<input id="EMERGENCY_CONTACT_ADDRESS_1" name="EMERGENCY_CONTACT_ADDRESS_1" class="element text large" value="{$user_data.EMERGENCY_CONTACT_ADDRESS_1}" type="text">
			<label for="EMERGENCY_CONTACT_ADDRESS_1">Street Address</label>
		</div>
	
		<div>
			<input id="EMERGENCY_CONTACT_ADDRESS_2" name="EMERGENCY_CONTACT_ADDRESS_2" class="element text large" value="{$user_data.EMERGENCY_CONTACT_ADDRESS_2}" type="text">
			<label for="EMERGENCY_CONTACT_ADDRESS_2">Address Line 2</label>
		</div>
	
		<div class="left">
			<input id="EMERGENCY_CONTACT_CITY" name="EMERGENCY_CONTACT_CITY" class="element text medium" value="{$user_data.EMERGENCY_CONTACT_CITY}" type="text">
			<label for="EMERGENCY_CONTACT_CITY">City</label>
		</div>
	
		<div class="right">
			<input id="EMERGENCY_CONTACT_STATE" name="EMERGENCY_CONTACT_STATE" class="element text medium" value="{$user_data.EMERGENCY_CONTACT_STATE}" type="text">
			<label for="EMERGENCY_CONTACT_STATE">State / Province / Region</label>
		</div>
	
		<div class="left">
			<input id="EMERGENCY_CONTACT_ZIP" name="EMERGENCY_CONTACT_ZIP" class="element text medium" maxlength="15" value="{$user_data.EMERGENCY_CONTACT_ZIP}" type="text">
			<label for="EMERGENCY_CONTACT_ZIP">Postal / Zip Code</label>
		</div>
