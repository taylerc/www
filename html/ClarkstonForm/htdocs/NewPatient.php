...
$smarty->template_dir = '/home1/columch7/public_html/columbiaphysicaltherapyinc/ClarkstonForm/templates/';
$smarty->compile_dir  = '/home1/columch7/public_html/columbiaphysicaltherapyinc/ClarkstonForm/templates_c/';
$smarty->config_dir   = '/home1/columch7/public_html/columbiaphysicaltherapyinc/ClarkstonForm/configs/';
$smarty->cache_dir    = '/home1/columch7/public_html/columbiaphysicaltherapyinc/ClarkstonForm/cache/';
...
$validating_regex = array(
	...
	"WORK_PHONE_2" => "/(^\d{3}$)/",
	"WORK_PHONE_3" => "/(^\d{4}$)/",
	"EMERGENCY_PHONE_1" => "/(^\d{3}$)/",
	"EMERGENCY_PHONE_2" => "/(^\d{3}$)/",
	"EMERGENCY_PHONE_3" => "/(^\d{4}$)/",
	...
	"EMERGENCY_CONTACT_ADDRESS_1" => "/([0-9]{1,7} [A-Za-z0-9\.]{1,45})/",
	"EMERGENCY_CONTACT_CITY" => "/(^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$)/",
	"EMERGENCY_CONTACT_STATE" => "/^[A-Z]{2}$/",
	"EMERGENCY_CONTACT_ZIP" => "/(^\d{5}$)/",
...
$error_dictionary = array(
	...
	"EMERGENCY_PHONE_1" => "<html><body><span class=error>Please make sure the there are 3 digits in the first section of the emergency phone number.</span></body></html>",
	"EMERGENCY_PHONE_2" => "<html><body><span class=error>Please make sure the there are 3 digits in the second section of the emergency phone number.</span></body></html>",
	"EMERGENCY_PHONE_3" => "<html><body><span class=error>Please make sure the there are 4 digits in the third section of the emergency phone number.</span></body></html>",
	...
	"DOB_1" => "<html><body><span class=error>Please Enter a valid month for the date of birth.</span></body></html>",
	"DOB_2" => "<html><body><span class=error>Please Enter a valid day for the the date of birth.</span></body></html>",
	"DOB_3" => "<html><body><span class=error>Please Enter a valid year for the date of birth.</span></body></html>",
	...
	"SPOUSE_SSN" => "<html><body><span class=error>Please make sure there are 9 digits in your spouse's SSN, and that you have placed dashes correctly.</span></body></html>",
	"SPOUSE_DOB_1" => "<html><body><span class=error>Please Enter a valid month for the spouse's date of birth.</span></body></html>",
	"SPOUSE_DOB_2" => "<html><body><span class=error>Please Enter a valid day for the the spouse's date of birth.</span></body></html>",
	"SPOUSE_DOB_3" => "<html><body><span class=error>Please Enter a valid year for the spouse's date of birth.</span></body></html>",
	...
	"MOTHER_SSN" => "<html><body><span class=error>Please make sure there are 9 digits in the mother's SSN, and that you have placed dashes correctly.</span></body></html>",
	...
	"FATHER_SSN" => "<html><body><span class=error>Please make sure there are 9 digits in the father's SSN, and that you have placed dashes correctly.</span></body></html>",
	...
	"EMERGENCY_CONTACT_ADDRESS_1" => "<html><body><span class=error>Please enter a valid emergency contact address.</span></body></html>",
	"EMERGENCY_CONTACT_CITY" => "<html><body><span class=error>Please enter a valid emergency contact city name.</span></body></html>",
	"EMERGENCY_CONTACT_STATE" => "<html><body><span class=error>Please enter a valid emergency contact state.</span></body></html>",
	"EMERGENCY_CONTACT_ZIP" => "<html><body><span class=error>Please make sure there are 5 digits in the emergency contact zip code.</span></body></html>",
	...
	"TODAY_DATE_1" => "<html><body><span class=error>Please enter a valid month for the date for today.</span></body></html>",
	"TODAY_DATE_2" => "<html><body><span class=error>Please enter a valid day for the date for today.</span></body></html>",
	"TODAY_DATE_3" => "<html><body><span class=error>Please enter a valid year for the date for today.</span></body></html>"
);
...
if(empty($_POST)){
	$smarty->display('/home1/columch7/public_html/columbiaphysicaltherapyinc/ClarkstonForm/templates/form.tpl');
}
...
//If there are no errors, the user is shown a thank-you screen, and their data is imported into the database.
	...
	$db->exec("INSERT INTO clarkston_new_patients (
		FIRST_NAME,
		LAST_NAME, 
		PHONE,
		WORK_PHONE,
		...
		EMERGENCY_CONTACT_CITY_STATE_ZIP,
		...
		'(". $escaped_values["EMERGENCY_PHONE_1"] .")". $escaped_values["EMERGENCY_PHONE_2"] ."-". $escaped_values["EMERGENCY_PHONE_3"] ."',
		...
		'". encrypt_text($escaped_values["FATHER_SSN"],$key1,$key2) ."',
		...
		'". $escaped_values["EMERGENCY_CONTACT_ADDRESS_1"] ." ". $escaped_values["EMERGENCY_CONTACT_ADDRESS_2"] ."',
		'". $escaped_values["EMERGENCY_CONTACT_CITY"] .", ". $escaped_values["EMERGENCY_CONTACT_STATE"] ." ". $escaped_values["EMERGENCY_CONTACT_ZIP"] ."',
