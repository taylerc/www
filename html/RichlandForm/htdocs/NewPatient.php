...
$smarty->template_dir = '/home1/columch7/public_html/columbiaphysicaltherapyinc/RichlandForm/templates/';
$smarty->compile_dir  = '/home1/columch7/public_html/columbiaphysicaltherapyinc/RichlandForm/templates_c/';
$smarty->config_dir   = '/home1/columch7/public_html/columbiaphysicaltherapyinc/RichlandForm/configs/';
$smarty->cache_dir    = '/home1/columch7/public_html/columbiaphysicaltherapyinc/RichlandForm/cache/';
...
$error_dictionary = array(
	...
	"SPOUSE_PHONE_1" => "<html><body><span class=error>Please make sure the there are 3 digits in the first section of your spouse's home phone number.</span></body></html>",
	"SPOUSE_PHONE_2" => "<html><body><span class=error>Please make sure the there are 3 digits in the second section of your spouse's home phone number.</span></body></html>",
	"SPOUSE_PHONE_3" => "<html><body><span class=error>Please make sure the there are 4 digits in the third section of your spouse's home phone number.</span></body></html>",
...
if(empty($_POST)){
	$smarty->display('/home1/columch7/public_html/columbiaphysicaltherapyinc/RichlandForm/templates/form.tpl');
}
...
//If there are no errors, the user is shown a thank-you screen, and their data is imported into the database.
	...
	$db->exec("INSERT INTO richland_new_patients (
		FIRST_NAME, 
		LAST_NAME, 
		PHONE, 
		CELL_PHONE, 
		...
		'(". $escaped_values["SPOUSE_PHONE_1"] .")". $escaped_values["SPOUSE_PHONE_2"] ."-". $escaped_values["SPOUSE_PHONE_3"] ."',
