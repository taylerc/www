...
$smarty->template_dir = '/home1/columch7/public_html/columbiaphysicaltherapyinc/MeridianForm2/templates/';
$smarty->compile_dir  = '/home1/columch7/public_html/columbiaphysicaltherapyinc/MeridianForm2/templates_c/';
$smarty->config_dir   = '/home1/columch7/public_html/columbiaphysicaltherapyinc/MeridianForm2/configs/';
$smarty->cache_dir    = '/home1/columch7/public_html/columbiaphysicaltherapyinc/MeridianForm2/cache/';
...
if(empty($_POST)){
	$smarty->display('/home1/columch7/public_html/columbiaphysicaltherapyinc/MeridianForm2/templates/form.tpl');
...
//If there are no errors, the user is shown a thank-you screen, and their data is imported into the database.
	...
	$db->exec("INSERT INTO meridian_new_patients (
		FIRST_NAME, 
		LAST_NAME, 
		CELL_PHONE, 
		HOME_PHONE, 
