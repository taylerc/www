...
$smarty->template_dir = '/home1/columch7/public_html/columbiaphysicaltherapyinc/SantiamForm/templates/';
$smarty->compile_dir  = '/home1/columch7/public_html/columbiaphysicaltherapyinc/SantiamForm/templates_c/';
$smarty->config_dir   = '/home1/columch7/public_html/columbiaphysicaltherapyinc/SantiamForm/configs/';
$smarty->cache_dir    = '/home1/columch7/public_html/columbiaphysicaltherapyinc/SantiamForm/cache/';
...
$error_dictionary = array(
	...
	"MOTHER_PHONE_1" => "<html><body><span class=error>Please make sure the there are 3 digits in the first section of the patient's mother's phone number.</span></body></html>",
	"MOTHER_PHONE_2" => "<html><body><span class=error>Please make sure the there are 3 digits in the second section of the patient's mother's phone number.</span></body></html>",
	"MOTHER_PHONE_3" => "<html><body><span class=error>Please make sure the there are 4 digits in the third section of the patient's mother's phone number.</span></body></html>",
	...
	"FATHER_PHONE_1" => "<html><body><span class=error>Please make sure the there are 3 digits in the first section of the patient's father's phone number.</span></body></html>",
	"FATHER_PHONE_2" => "<html><body><span class=error>Please make sure the there are 3 digits in the second section of the patient's father's phone number.</span></body></html>",
	"FATHER_PHONE_3" => "<html><body><span class=error>Please make sure the there are 4 digits in the third section of the patient's father's phone number.</span></body></html>",
...
if(empty($_POST)){
	$smarty->display('/home1/columch7/public_html/columbiaphysicaltherapyinc/SantiamForm/templates/form.tpl');
}
...
//If there are no errors, the user is shown a thank-you screen, and their data is imported into the database.
	...
	$db->exec("INSERT INTO santiam_new_patients (
		FIRST_NAME, 
		LAST_NAME, 
		RETURNING_PATIENT,
		PHONE,
		...
		'". $escaped_values["RETURNING_PATIENT"] ."', 
		...
		'". $escaped_values["GENDER"] ."','". encrypt_text($escaped_values["SSN"],$key1,$key2) ."',
		...
		'(". $escaped_values["MOTHER_PHONE_1"] .")". $escaped_values["MOTHER_PHONE_2"] ."-". $escaped_values["MOTHER_PHONE_3"] ."',
		'". $escaped_values["MOTHER_ADDRESS_1"] ." ". $escaped_values["MOTHER_ADDRESS_2"] ."',
		'". $escaped_values["MOTHER_CITY"] ."',
		'". $escaped_values["MOTHER_STATE"] ."',
		'". $escaped_values["MOTHER_ZIP"] ."','". encrypt_text($escaped_values["MOTHER_SSN"],$key1,$key2) ."',
		...
		'(". $escaped_values["FATHER_PHONE_1"] .")". $escaped_values["FATHER_PHONE_2"] ."-". $escaped_values["FATHER_PHONE_3"] ."',
