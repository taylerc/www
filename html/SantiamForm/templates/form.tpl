...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<label class="description" for="RETURNING_PATIENT">Are you a returning Patient? </label>
		<span>
			<input id="RETURNING_PATIENT_1" name="RETURNING_PATIENT" class="element radio" type="radio" value="Y" {if $user_data.RETURNING_PATIENT eq 'Y'}checked{/if}/>
<label class="choice" for="RETURNING_PATIENT_1">Yes</label>
<input id="RETURNING_PATIENT_2" name="RETURNING_PATIENT" class="element radio" type="radio" value="N" {if $user_data.RETURNING_PATIENT eq 'N'}checked{/if}/>
<label class="choice" for="RETURNING_PATIENT_2">No</label>
...
<h3>If Married</h3>
		...
		<label class="description" for="MOTHER_PHONE">Phone </label>
		<span>
			<input id="MOTHER_PHONE_1" name="MOTHER_PHONE_1" class="element text" size="3" maxlength="3" value="{$user_data.MOTHER_PHONE_1}" type="text"> -
			<label for="MOTHER_PHONE_1">(###)</label>
		</span>
		<span>
			<input id="MOTHER_PHONE_2" name="MOTHER_PHONE_2" class="element text" size="3" maxlength="3" value="{$user_data.MOTHER_PHONE_2}" type="text"> -
			<label for="MOTHER_PHONE_2">###</label>
		</span>
		<span>
	 		<input id="MOTHER_PHONE_3" name="MOTHER_PHONE_3" class="element text" size="4" maxlength="4" value="{$user_data.MOTHER_PHONE_3}" type="text">
			<label for="MOTHER_PHONE_3">####</label>
		</span>
		...
		<label class="description" for="FATHER_PHONE">Phone </label>
		<span>
			<input id="FATHER_PHONE_1" name="FATHER_PHONE_1" class="element text" size="3" maxlength="3" value="{$user_data.FATHER_PHONE_1}" type="text"> -
			<label for="FATHER_PHONE_1">(###)</label>
		</span>
		<span>
			<input id="FATHER_PHONE_2" name="FATHER_PHONE_2" class="element text" size="3" maxlength="3" value="{$user_data.FATHER_PHONE_2}" type="text"> -
			<label for="FATHER_PHONE_2">###</label>
		</span>
		<span>
	 		<input id="FATHER_PHONE_3" name="FATHER_PHONE_3" class="element text" size="4" maxlength="4" value="{$user_data.FATHER_PHONE_3}" type="text">
			<label for="FATHER_PHONE_3">####</label>
		</span>
